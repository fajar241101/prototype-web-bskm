    ...
    <main className="content">
        <div className="bagian1">
            <div className="container-bagian1">
                <h2 style={{marginTop: 0}}>Daftar Program Kerja Bidang Organisasi</h2>
                <div className="list-proker">
                    ...
                    <Link to='/orgsatu'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, facilis qui asperiores quae veritatis ratione dolor dolorum cumque maiores officia neque itaque iste sequi deleniti? Placeat et explicabo amet sit!</Link>
                ...
                <form action="">
                    <Link to='/homepage'>
                    <button type='button'>Proker Pimpinan Inti</button>
                    </Link>
                </form>
                <form action="">
                    <Link to='/homepage'>
        ...
        <div className="bagian2">
            <div className="container">
                ...
                <div className="bookWrapper">
                    <iframe src="https://drive.google.com/file/d/1gQYkscsLzQSGsHebnnn07blKa7as8xW7/preview" width="100%" allow="autoplay" style={{border: 'none'}}></iframe>
                </div>
                <p>Wikan Cahyaning Purbandari</p>
                <p>20/462304/PA/20276</p>
                <p className="deskripsi">Memberikan rangkuman materi mata pelajaran matematika untuk siswa-siswi kelas 6 SD N Sumberadi untuk memudahkan dalam memahami materi yang disampaikan di sekolah
                    melalui pemberian booklet.</p>
