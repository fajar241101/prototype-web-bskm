    ...
    <main className="content">
        <div className="bagian1">
            <div className="container-bagian1">
                <h2 style={{marginTop: 0}}>Daftar Program Kerja Bidang Ekonomi dan Kewirausahaan</h2>
                <div className="list-proker">
                    ...
                    <Link to='/ekowir'>Pedoman Administrasi dan Organisasi Ikatan Mahasiswa Muhammadiyah Daerah Istimewa Yogyakarta</Link>
                    ...
                    <Link to='/ekowir'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, facilis qui asperiores quae veritatis ratione dolor dolorum cumque maiores officia neque itaque iste sequi deleniti? Placeat et explicabo amet sit!</Link>
                ...
                <form action="">
                    <Link to='/homepage'>
                    <button type='orgsatu'>Proker Bidang Immawati</button>
                    </Link>
                </form>
                <form action="">
                    <Link to='/homepage'>
