...
import '../style/style-khaldun.css';
...
const Khaldun = () => {
            ...
            <ul className='navbar'>
                ...
                <li className='dropdown'>
                    ...
                    <ul className='dropdown-content'>
                        ...
                        <li><a className='active-navbar'><Link to="/khaldun">Pimpinan Komisariat Ibnu-Khaldun</Link></a></li>
    ...
    <main className="content-khaldun">
        <div className="artikel">
            <h1 style={{marginTop: 0 , textAlign: 'center'}}>Pimpinan Komisariat Ibnu-Khaldun</h1>
            <div className="paragraf">
                <div className="img-container-khaldun">
                    <img className="slides" src={headerKhaldun} alt="Festival Begawe Jelo Nyensek 2019 di Desa Sukarara"/>
                </div>
                <div>
                <p>
        ...
        <div className="list-artikel">
            <div>
                ...
                <div className="row-khaldun">
                    <div className="column-khaldun">
                        <a><Link to='/rizmi'>
                            <div className="content-body-khaldun">
                ...
                <div className="row-khaldun">
                    ...
                    <div className="column-khaldun">
                        <a href="kampung-flory.html">
                            <div class="content-body-khaldun">
