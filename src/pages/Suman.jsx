...
const Suman = () => {
            ...
            <ul className='navbar'>
                ...
                <li className='dropdown'>
                    ...
                    <ul className='dropdown-content'>
                        ...
                        <li><a className='active-navbar'><Link to="/suman">Pimpinan Komisariat Sutan Mansyur</Link></a></li>
    ...
    <main className="content-suman">
        <div className="artikel">
            <h1 style={{marginTop: 0 , textAlign: 'center'}}>Pimpinan Komisariat Sutan Mansyur</h1>
            <div className="paragraf">
                <div className="img-container-suman">
                    <img className="slides" src={headerSuman} alt="Festival Begawe Jelo Nyensek 2019 di Desa Sukarara"/>
                </div>
                <div>
                <p>
        ...
        <div className="list-artikel">
            <div>
                ...
                <div className="row-suman">
                    <div className="column-suman">
                        <a><Link to='/rizmi'>
                            <div className="content-body-suman">
                                <img src={headerRizmi} alt="Kalurahan Tirtoadi" style={{width:"100%"}}/>
                                <p>Pimpinan Komisariat Al-Khawarizmi</p>
                            </div>
                            </Link>
                        </a>
                    </div>
                    ...
                    <div className="column-suman">
                        <a><Link to='/badawi'>
                            <div className="content-body-suman">
                                <img src={abadImg} alt="Kalurahan Tirtoadi" style={{width:"100%"}}/>
