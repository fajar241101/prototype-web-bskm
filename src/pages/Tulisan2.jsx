    ...
    <main className="content-tulisan">
        ...
        <div className="bagian2-tulisan">
            <div className="container-tulisan">
                <h1 style={{textAlign: 'center', marginTop: 0, textDecoration: 'underline'}}>Jurnal Kader IMM BSKM Immawati Siti Rohanah</h1>
                <br></br>
                <div className="bookWrapper">
                    <iframe src="https://drive.google.com/file/d/141f0uK8K8Z2wkNlStFBuRA86keO2CtZU/preview" style={{border: 'none', width: '100%' , allow: 'autoplay'}}></iframe>
                </div>
                </div>
            </div>
    </main>
