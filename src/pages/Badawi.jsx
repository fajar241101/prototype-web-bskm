...
const Badawi = () => {
            ...
            <ul className='navbar'>
                ...
                <li className='dropdown'>
                    ...
                    <ul className='dropdown-content'>
                        ...
                        <li><a className='active-navbar'><Link to="/badawi">Pimpinan Komisariat Ahmad Badawi</Link></a></li>
                    </ul>
                </li>
    ...
    <main className="content-badawi">
        <div className="artikel">
            <h1 style={{marginTop: 0 , textAlign: 'center'}}>Pimpinan Komisariat Ahmad Badawi</h1>
            <div className="paragraf">
                <div className="img-container-badawi">
                    <img className="slides" src={abadImg} alt="Festival Begawe Jelo Nyensek 2019 di Desa Sukarara"/>
                </div>
                <div>
                <p>
            ...
            <div>
                ...
                <div className="row-badawi">
                    <div className="column-badawi">
                        <a><Link to='/rizmi'>
                            <div className="content-body-badawi">
