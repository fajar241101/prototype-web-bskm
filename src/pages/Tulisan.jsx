    ...
    <main className="content-tulisan">
        ...
        <div className="bagian2-tulisan">
            <div className="container-tulisan">
                <h1 style={{textAlign: 'center', marginTop: 0, textDecoration: 'underline'}}>Jurnal Kader IMM BSKM Immawan Fachrurizal Mahendra</h1>
                <br></br>
                <div className="bookWrapper">
                    <iframe src="https://drive.google.com/file/d/1O6MQyZ1BxuvbbYqHSurzBeShpjHFexh4/preview" style={{border: 'none', width: '100%' , allow: 'autoplay'}}></iframe>
                </div>
                </div>
            </div>
    </main>
