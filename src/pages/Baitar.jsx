...
const Baitar = () => {
            ...
            <ul className='navbar'>
                ...
                <li className='dropdown'>
                    ...
                    <ul className='dropdown-content'>
                        ...
                        <li><a className='active-navbar'><Link to="/baitar">Pimpinan Komisariat Al-Baitar</Link></a></li>
    ...
    <main className="content-baitar">
        <div className="artikel">
            <h1 style={{marginTop: 0 , textAlign: 'center'}}>Pimpinan Komisariat Al-Baitar</h1>
            <div className="paragraf">
                <div className="img-container-baitar">
                    <img className="slides" src={logoBaitar} alt="Festival Begawe Jelo Nyensek 2019 di Desa Sukarara"/>
                </div>
                <div>
                <p>
