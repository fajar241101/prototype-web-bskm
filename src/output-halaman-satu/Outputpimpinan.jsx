...
import pedomanAdmin from '../assets/Proker/pedoman.jpg';
import blank from '../assets/blank.jpg';
import { Link } from 'react-router-dom';

const Outputpimpinan = () => {
        ...
        <div className="row-output">
            <div className="column-output">
                <div className="kotak-output">
                    <img src={pedomanAdmin} alt="Pembuatan Pupuk Organik Cair atau POC dengan Memanfaatkan Sampah Dapur Rumah Tangga"/>
                    <h3>Pedoman Administrasi dan Organisasi Ikatan Mahasiswa Muhammadiyah Daerah Istimewa Yogyakarta</h3>
                    <p>Published: Sekretaris Umum PC IMM BSKM</p>
                    <p>Source: DPD IMM DIY</p>
                    <p>Pedoman administrasi ini disusun berdasarkan kebutuhan di lingkup wilayah kepemimpinan IMM di DIY yang dikembangkan
                        dari pedoman administrasi dan organisasi yang telah disusun dan diterbitkan oleh Dewan Pimpinan Pusat Ikatan Mahasiswa
                        Muhammadiyah
                    </p>
                    <Link to='/pimpinan'>Lihat selengkapnya</Link>
                </div>
                <div className="kotak-output">
