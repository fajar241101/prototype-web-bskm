...
const Outputspm = () => {
    ...
    <main className="content-output">
        <h1>Bidang Sosial dan Pemberdayaan Masyarakat</h1>
        <div className="row-output">
            <div className="column-output">
                <div className="kotak-output">
                    ...
                    <h3>Pembuatan Pupuk Organik Cair atau POC dengan Memanfaatkan Sampah Dapur Rumah Tangga</h3>
                    <p>Wikan Cahyaning Purbandari</p>
                    <p>18/431027/TK/47620</p>
                ...
                <div className="kotak-output">
                    ...
                    <h3>Penyuluhan dan Pembuatan Booklet Mengenai Pendaftaran Perizinan UMKM di Jodag</h3>
                    <p>Maximillian Hanzel Diaz Putra</p>
                    <p>20/458740/HK/22472</p>
            ...
            <div className="column-output">
                <div className="kotak-output">
                    ...
                    <h3>Pola Hidup Bersih dan Sehat dengan Pemberantasan Jentik Nyamuk</h3>
                    <p>Listiana Dwi Ardana & Levina Larassati Apriliana</p>
                    <p>20/456584/PA/19771 || 20/457081/SV/17528</p>
                ...
                <div className="kotak-output">
                    ...
                    <h3>Penyuluhan dan Pembuatan Booklet Informasi Mengenai Kebiasan Kecil dan Sederhana yang Mengubah Hidup menjadi Lebih Sehat</h3>
                    <p>Wikan Cahyaning Purbandari & Dinda Farica Anaz</p>
                    <p>20/462304/PA/20276 || 20/459595/PS/08210</p>
            ...
            <div className="column-output">
                <div className="kotak-output">
                    ...
                    <h3>Poster Saving Challenge</h3>
                    <p>Levina Larassati Apriliana & Wikan Cahyaning Purbandari</p>
                    <p>20/457081/SV/17528 || 20/462304/PA/20276</p>
                ...
                <div className="kotak-output">
                    ...
                    <h3>Poster Cuci Tangan dengan Sabun secara benar pada Area Fasilitas Umum di Dukuh Jodag</h3>
                    <p>Listiana Dwi Ardana</p>
                    <p>20/456584/PA/19771</p>
            ...
            <div className="column-output">
                <div className="kotak-output">
                    ...
                    <h3>Poster Money Tracker Challenge</h3>
                    <p>Levina Larassati Apriliana & Wikan Cahyaning Purbandari</p>
                    <p>20/457081/SV/17528 || 20/462304/PA/20276</p>
                ...
                <div className="kotak-output">
                    ...
                    <h3>Meningkatkan Minat Belajar Siswa Melalui Pengajaran dan Pengadaan Buku Materi Tambahan (Booklet) Matematika untuk Anak-anak di Dukuh Jodag</h3>
                    <p>Wikan Cahyaning Purbandari</p>
                    <p>20/462304/PA/20276</p>
